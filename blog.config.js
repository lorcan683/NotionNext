...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://www.lorcanli.com/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Lorcan', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的旅行者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'Lorcanli.com', // 网站地址
